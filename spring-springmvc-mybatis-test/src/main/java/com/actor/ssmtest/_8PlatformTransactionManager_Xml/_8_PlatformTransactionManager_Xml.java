...
@ContextConfiguration(locations = "classpath:_8_PlatformTransactionManager.xml")
public class _8_PlatformTransactionManager_Xml {

    @Autowired
    private AccountDaoImpl_TransactionManager accountDao;
