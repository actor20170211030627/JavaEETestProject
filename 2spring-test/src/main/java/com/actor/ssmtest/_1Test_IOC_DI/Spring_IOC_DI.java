...
import com.actor.ssmtest._1Test_IOC_DI.service.CustomerService;
import com.actor.ssmtest._1Test_IOC_DI.service.CustomerServiceImpl;
...
public class Spring_IOC_DI {
    ...
    public static void main(String[] args) {
        //spring-context
        ApplicationContext ac = new ClassPathXmlApplicationContext("_1Spring_IOC_DI.xml");
//        CustomerServiceImpl userServiceImpl = (CustomerServiceImpl) ac.getBean("customerService");//强转也可以
        ...
        Resource resource = new ClassPathResource("_1Spring_IOC_DI.xml");        //spring-core
        BeanFactory factory = new XmlBeanFactory(resource);                     //spring-beans
        CustomerService customerService2 = factory.getBean("customerService", CustomerServiceImpl.class);
